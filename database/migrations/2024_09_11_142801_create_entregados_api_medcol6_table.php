...
class CreateEntregadosApiMedcol6Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entregados_api_medcol6', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('entregados_api_medcol6');
    }
}
