...
class CreateEntregadosApiMedcoldsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entregados_api_medcold', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('entregados_api_medcold');
    }
}
