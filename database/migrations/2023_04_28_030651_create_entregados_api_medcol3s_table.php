...
class CreateEntregadosApiMedcol3sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entregados_api_medcol3', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('entregados_api_medcol3');
    }
}
