                    ...
                    <div class="card-body col-md-12 table-responsive p-2">
                        <table id="mipres" class="table text-nowrap table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><button type="button" name="reportarfacturacion" title="Clic para reportar facturacion" id="{{$item['ID'] ?? ''}}" data-p="{{$item['NoPrescripcion'] ?? ''}}" data-tt="{{$item['TipoTec'] ?? ''}}" data-ct="{{$item['ConTec'] ?? ''}}" data-tid="{{$item['TipoIDPaciente'] ?? ''}}" data-idp="{{$item['NoIDPaciente'] ?? ''}}" data-e="{{$item['NoEntrega'] ?? ''}}" data-cum="{{$item['CodTecEntregado'] ?? ''}}" data-ve="{{$item['ValorEntregado'] ?? ''}}" data-ce="{{$item['CantTotEntregada'] ?? ''}}" class="reportar_fac btn-float  bg-gradient-danger btn-sm tooltipsC" title="Clic para reportar facturacion">
