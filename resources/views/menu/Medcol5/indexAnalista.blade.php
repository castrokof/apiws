...
@include('menu.Medcol5.form.forminforme')
@include('menu.Medcol5.tabs.tabsIndexAnalista')
@include('menu.Medcol5.modal.modalindexresumen')
@include('menu.Medcol5.modal.modalindexaddseguimiento')

@include('menu.Medcol5.modal.modalPendientes')
@include('menu.Medcol5.modal.modalDetallePendiente')

@include('menu.Medcol5.modal.modalindexresumenpendientes')
    ...
    $(document).ready(function() {
                ...
                if (tabId === "custom-tabs-one-datos-del-paciente-tab") {
                    ...
                    var datatable =
                        $('#tdesabastecidos').DataTable({
                            ...
                            ajax: {
                                url: "{{route('medcol5.desabastecidos')}}",
                                data:{
                                     _token:"{{ csrf_token() }}"
                                    },
                                method: 'POST'
        ...
        function fill_datatable_f(nivel_idp2 = '') {
            var tobservaciones = $('#tobservaciones').DataTable({
                ...
                ajax: {
                    url: "{{ route('medcol5.observaciones')}}",
                    //type: "get",
                    data: {
                        id: nivel_idp2
                    }
