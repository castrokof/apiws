            ...
            <div class="row">
                <div class="content-header">
                  <div class="container-fluid">
                    <div class="row lg-12">
                      <div class="col-sm-12">
                        <h1 class="m-0 text-dark">Informe Dispensación</h1>
                      </div><!-- /.col -->
                      ...
                      <div class="card-body">
                        ...
                        <div class="col-lg-3">
                           <label for="drogueria" class="col-xs-4 control-label requerido">drogueria</label>
                           <select name="drogueria[]" id="drogueria" class="js-example-basic-multiple form-control select2bs4" multiple="multiple" style="width: 100%;" required>
                                
                           </select>
                        </div>
                        <div class="col-lg-3">
                            <label for="historia" class="col-xs-4 control-label ">Documento paciente</label>
                            <textarea name="historia" id="historia" class="textarea form-control" rows="3" placeholder="Para consultar varios documentos separelos por , " ></textarea>
...
drogueria = $('#drogueria').val();
    ...
    if(fechaini != '' && fechafin != '' || historia != '' || drogueria != '' ){

        $('#dispensadocli').DataTable().destroy();

        fill_datatable_tabla(fechaini, fechafin, historia, drogueria );

    }else{

        Swal.fire({
        title: 'Debes digitar fecha inicial y fecha final o Documento',
        icon: 'warning',
        buttons:{
            cancel: "Cerrar"
...
function  fill_datatable_tabla(fechaini = '', fechafin = '', historia = '', drogueria = ''){
...
var datatable =  $('#dispensadocli').DataTable({
                            ...
                            ajax: {
                                ...
                                data:{
                                         fechaini:fechaini, fechafin:fechafin, historia:historia, drogueria:drogueria,
                                          _token:"{{ csrf_token() }}"
                                         },
                                method: 'POST'
                            },
 ...
 //Consulta de datos de la tabla lista-detalle
            $("#drogueria").select2({
                language: "es",
                placeholder: 'Seleccione una drogueria',
                allowClear: true,
                ajax: {
                    url: "{{ route('medcolCli.drogueria') }}",
                    dataType: 'json',
                    delay: 250,
