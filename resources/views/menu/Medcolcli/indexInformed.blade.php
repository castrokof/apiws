          ...
          <div class="card shadow-lg p-3 mb-5 card-warning card-tabs">
            <div class="card-header p-0 pt-1">
              <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="custom-tabs-one-datos-del-pago-tab" data-toggle="pill" href="#custom-tabs-one-datos-del-pago" role="tab" aria-controls="custom-tabs-one-datos-del-pago" aria-selected="false">Lista de Dispensados</a>
                </li>
              </ul>
            </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#buscar').click(function() {
        ...
        if (fechaini != '' && fechafin != '' || historia != '') {

          $('#dispensadocli').DataTable().destroy();

          fill_datatable_tabla(fechaini, fechafin, historia);
      ...
      function fill_datatable_tabla(fechaini = '', fechafin = '', historia = '') {
