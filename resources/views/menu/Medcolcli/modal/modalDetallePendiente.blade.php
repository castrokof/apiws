<div class="modal fade" tabindex="-1" id="modal-show-pendientes" role="dialog" aria-labelledby="myLargeModalLabel" hidden.bs.modal="limpiarModal()">
                                            ...
                                            <div class="tab-pane fade active show" id="custom-tabs-one-datos-del-paciente" role="tabpanel" aria-labelledby="custom-tabs-one-datos-del-paciente-tab">
                                                <div class="card-body">
                                                    <form id="form-general-show" class="form-horizontal">
                                                        @csrf
                                                        @include('menu.Medcold.form.formDetalle')
