                 ...
                 @if(Auth::user()->rol == '1' || Auth::user()->rol == '2')
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="list-group">
                                ...
                                <a href="{{ route('medcol3.dispensado') }}" class="list-group-item list-group-item-action">
                                    <i class="fas fa-share-square"></i> Gestionar Dispensación de San Fernando <span
                    ...
                    <div class="card bg-info">
                        <div class="card-body text-center">
                            ...
                            <div class="list-group">
                                <a href="{{ route('medcol3.dispensado') }}" class="list-group-item list-group-item-action">
                                    <i class="far fa-share-square"></i> Gestionar Dispensación de PCE-Huerfanas-Biologicos <span
                     ...
                     <div class="card bg-light">
                        <div class="card-body text-center">
                            ...
                            <div class="list-group">
                                ...
                                <a href="{{ route('medcol3.dispensado') }}" class="list-group-item list-group-item-action">
                                    <i class="fas fa-share-square"></i> Consultar Dispensación Medcol <span
