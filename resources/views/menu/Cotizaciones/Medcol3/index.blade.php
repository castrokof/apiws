...
@section('scripts')
    <script src="{{ asset('assets/pages/scripts/admin/cotizaciones/index.js') }}"></script>
@endsection

@section('contenido')
    @include('menu.Cotizaciones.Medcol3.tablas.tablaIndexListas')
    @include('menu.Cotizaciones.Medcol3.modal.modalListas')
    @include('menu.Cotizaciones.Medcol3.modal.modalListasDetalle')
    @include('menu.Cotizaciones.Medcol3.modal.modalListasDetalleIndex')
@endsection
...
@section('scriptsPlugins')
    ...
    <script>
        $(document).ready(function() {
            ...
            var datatable = $('#listasCotizaciones').DataTable({
                ...
                ajax: {
                    url: "{{ route('medcol3.listascotizaciones') }}",
                },
                columns: [
                    {
                        data: 'action',
