...
@section('contenido')
    @include('menu.Compras.Medcol4.modal.modalCompras')
    @include('menu.Compras.Medcol4.modal.modalFacturaArticulo')
@endsection
       ...
       function calcularTotales() {
        ...
        $('#totalTotal').val(totalTotal.toLocaleString('es-CO', {
            ...
            function listasdetalleproveedor() {
                ...
                var url = "/detalleproveedores/" + ids1;
