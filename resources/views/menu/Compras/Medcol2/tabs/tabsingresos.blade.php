                ...
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-tabs-one-datos-del-entrada-tab" data-toggle="pill"
                            ...
                            aria-controls="custom-tabs-one-datos-del-entrada" aria-selected="false">Ordenes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " id="custom-tabs-one-datos-del-tablaentrada-tab" data-toggle="pill"
                            ...
                            aria-controls="custom-tabs-one-datos-del-tablaentrada" aria-selected="false">Tabla Ordenes</a>
                    </li>
                     {{-- <li class="nav-item">
                    ...
                    <form id="form-general" class="form-horizontal" method="POST">
                        <div class="tab-pane fade active show" id="custom-tabs-one-datos-del-entrada" role="tabpanel"
                            ...
                            <div class="card-body">
                                ...
                                @include('menu.Compras.Medcol2.form.formdatosbasicos')
                     ...
                     <div class="tab-pane fade  " id="custom-tabs-one-datos-del-tablaentrada" role="tabpanel"
                            ...
                            <div class="card-body">
                                ...
                                @include('menu.Compras.Medcol2.tablas.tablaIndexEntradas')
