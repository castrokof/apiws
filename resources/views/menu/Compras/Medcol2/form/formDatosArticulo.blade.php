...
<div class="form-group row">
  ...
  <div class="col-lg-3">
    ...
    <input type="text" name="precio_compra_subtotal_unitario" id="precio_compra_subtotal_unitario" class="form-control" value="{{old('cantidad')}}">
  </div>
  <div class="col-lg-2">
...
<div class="form-group row">
  ...
  <div class="col-lg-3">
    ...
    <input type="text" name="cantidad_iva_total" id="cantidad_iva_total" class="form-control " value="{{old('cantidad')}}" readonly>
  </div>
  <div class="col-lg-4">
...
<div class="form-group row">
  <div class="col-lg-6">
    ...
    <input name="usuario_id" id="usuario_id" class="form-control" value="{{Session()->get('id') ?? ''}}" readonly>
  </div>
...
<div class="col-lg-3">
  <input type="hidden" name="usuario_id" id="usuario_id" class="form-control" value="{{Session()->get('id') ?? ''}}" readonly>
</div>
