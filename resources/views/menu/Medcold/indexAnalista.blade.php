...
@include('menu.Medcold.form.forminforme')
@include('menu.Medcold.tabs.tabsIndexAnalista')
@include('menu.Medcold.modal.modalindexresumen')
@include('menu.Medcold.modal.modalindexaddseguimiento')

@include('menu.Medcold.modal.modalPendientes')
@include('menu.Medcold.modal.modalDetallePendiente')
@include('menu.Medcold.modal.modalindexresumenpendientes')
    ...
    $(document).ready(function() {
        ...
        function fill_datatable_f(nivel_idp2 = '') {
            var tobservaciones = $('#tobservaciones').DataTable({
                ...
                ajax: {
                    url: "{{ route('medcold.observaciones')}}",
                    type: "get",
                    data: {
                        id: nivel_idp2
                    }
        ...
        $(document).on('click', '#syncapi', function() {
            ...
            const text = 'De Medcol Dolor y paliativos';
