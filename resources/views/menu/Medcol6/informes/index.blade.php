...
@section('title', 'Informes Medcol')

@section('page-title', 'Informes - Medcol')
...
<style>
    /* Mejorar visualización de Select2 */
...
<div class="row">
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box">
            <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-capsules"></i></span>
            <div class="info-box-content">
                <span class="info-box-text">Informes Activos</span>
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Exportables</span>
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
                <span class="info-box-text">En Desarrollo</span>
                <span class="info-box-number">3</span>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="contrato" id="contrato" class="form-control select2bs4" data-placeholder="Seleccione una farmacia">
                            <option value="">Todas las farmacias</option>
                            <optgroup label="Farmacias Principales">
                                <option value="BIO1">BIO1 - Farmacia Biológicos</option>
                                ...
                                <option value="FRJA">FRJA - Farmacia Jamundí</option>
