                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <!--  @if (Route::has('register'))
                        ...
                        @if(Auth::user()->email == 'castrokof@gmail.com' || Auth::user()->email == 'sistemasmedcol@gmail.com' || Auth::user()->email == 'gerente@saludtempus.com' || Auth::user()->email == 'sistemas3.tempus@gmail.com')
