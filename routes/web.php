...
route::get('selectusuario', 'Listas\ListasDetalleController@selectUsuario')->name('selectusuario')->middleware('verified')->middleware('verifyuser');
...
Route::get('/ordenes/{numeroOrden}/excel', [OrdenCompraApiMedcol6Controller::class, 'exportarExcel'])->name('ordenes.exportar.excel');
Route::get('/ordenes/{numeroOrden}/ingreso', [OrdenCompraApiMedcol6Controller::class, 'vistaIngreso'])
    ->name('ordenes.ingreso');
Route::post('/ordenes/{numeroOrden}/ingreso/excel', [OrdenCompraApiMedcol6Controller::class, 'generarExcelIngreso'])
    ->name('ordenes.ingreso.excel');

//Moleculas, proveedores y codigos relacionados

Route::get('/moleculas/cargar-proveedores',  [MoleculaController::class, 'form'])
    ->name('moleculas.import.form');

Route::post('/moleculas/cargar-proveedores',  [MoleculaController::class, 'upload'])
    ->name('moleculas.import.upload');

Route::resource('moleculas', 'Compras\MoleculaController')
    ->parameters(['moleculas' => 'molecula']);

Route::resource('moleculas.codigos', 'Compras\MoleculaProveedorCodigoController')
    ->shallow()
    ->only(['index', 'create', 'store', 'edit', 'update', 'destroy']);

Route::get('/compras/ordenes/exportar', [OrdenCompraApiMedcol6Controller::class, 'exportExcel'])
    ->name('ordenes.exportar');

Route::get('/compras/ordenes-detalle/exportar', [OrdenCompraApiMedcol6Controller::class, 'exportExcelDetalle'])
    ->name('ordenes.detalle.exportar');
...
Route::get('/pacientes/sync-status', 'PacienteController@syncStatus')->name('pacientes.sync-status')->middleware('verified')->middleware('verifyuser');
