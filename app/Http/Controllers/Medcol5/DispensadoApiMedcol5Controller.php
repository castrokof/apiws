...
class DispensadoApiMedcol5Controller extends Controller
{
    /**
    ...
    if(Auth::user()->drogueria == '1'){            
        ...
        $dispensado =  DispensadoApiMedcol5::where([['estado', 'DISPENSADO'], ['fecha_suministro','>=', '2024-03-01 00:00:00']])->count();
        $revisado =  DispensadoApiMedcol5::where([['estado', 'REVISADO'],  ['fecha_suministro','>=', '2024-03-01 00:00:00']])->count();
        $anulado =  DispensadoApiMedcol5::where([['estado', 'ANULADA'],  ['fecha_suministro','>=', '2024-03-01 00:00:00']])->count();
        
    }else{
        
        $dispensado =  DispensadoApiMedcol5::where([['estado', 'DISPENSADO'], ['centroprod',$drogueria],  ['fecha_suministro','>=', '2024-03-01 00:00:00']])->count();
        $revisado =  DispensadoApiMedcol5::where([['estado', 'REVISADO'], ['centroprod',$drogueria],  ['fecha_suministro','>=', '2024-03-01 00:00:00']])->count();
        $anulado =  DispensadoApiMedcol5::where([['estado', 'ANULADA'],['centroprod',$drogueria],  ['fecha_suministro','>=', '2024-03-01 00:00:00']])->count();
    }
    ...
    public function index(Request $request)
    {
             ...
             return view('menu.Medcol5.indexDispensado');
    }
      ...
      public function index1(Request $request)
        {
            ...
            if ($request->ajax()) {
               ...
               $dispensado_api_medcol5 = DispensadoApiMedcol5::query();
                ...
                if (!empty($drogueria)) {
                    ...
                    if ($drogueria == 'EMO1') 
                    $dispensado_api_medcol5->whereIn('centroprod', ['EMO1', 'EVEN']);
                    else
                ...
                
                {
                    ...
                    $Resultados1 = $dispensado_api_medcol5->where('centroprod', $contrato)
                    ...
                    $dispensado_api_medcol5->whereBetween('fecha_suministro', [$fechaAi, $fechaAf]);
                ...
                $dispensado_api_medcol5->where('estado', 'DISPENSADO')->orWhereNull('estado');
        
                $resultados = $dispensado_api_medcol5->orderBy('fecha_suministro')->get();
            ...
            return view('menu.Medcol5.indexDispensado', ['droguerias' => $droguerias]);
        }
   ...
   public function disrevisado(Request $request)
        {
            ...
            if ($request->ajax()) {
                $query = DispensadoApiMedcol5::whereIn('estado', ['REVISADO', null])
                    ->orderBy('id');
            ...
            return view('menu.Medcol5.indexDispensado', ['droguerias' => $drogueria]);
        }
    ...
    public function adddispensacionarray(Request $request)
    {
       ...
       foreach ($add_factura as $add) {
                ...
                DispensadoApiMedcol5::where('id',$add['ID'])
                ->update([
    ...
    public function updateanuladosapi(Request $request)
    {
                ...
                try {
                    ...
                    foreach ($facturassapi as $factura) {
                        if (isset($factura['factura'])) {
                            $actualizados = DispensadoApiMedcol5::where('factura', $factura['factura'])
                            ...
                            $actualizados = DispensadoApiMedcol5::whereRaw("CONCAT(documento_origen, factura_origen) = ?", [$factura['factura_electronica']])
                            ->whereIn('estado', ['DISPENSADO', 'REVISADO'])
                            ->update([
                                'estado' => 'ANULADA',
                                'updated_at' => now()
        ...
        public function disanulado(Request $request)
            ...
            if ($request->ajax()) {
                $query = DispensadoApiMedcol5::whereIn('estado', ['ANULADA', null])
                    ->orderBy('id');
        ...
        try {
            ...
            foreach ($datos as $idd) {
                ...
                if (strtotime($fechaOrden) <= strtotime($fechaSuministro)) {
                    ...
                    DispensadoApiMedcol5::where('id', $idd['ID'])
                        ->update([
