  ...
  public function index1(Request $request)
  {
    ...
    if ($request->ajax()) {
      ...
      if ($request->fechaini != '' && $request->fechafin != '') {
        ...
        $pendientesapi = PendienteCliMedcol::whereIn('estado', ['PENDIENTE', 'ENTREGADO'])
          ->whereBetween('fecha_factura', [$fechaini . ' 00:00:00', $fechafin . ' 23:59:59']);


        $pendientesapi->where('fecha_factura', '>', '2023-07-31 00:00:00')->get();
        ...
        $pendientesapitoday = PendienteCliMedcol::whereIn('estado', ['PENDIENTE', 'ENTREGADO'])
