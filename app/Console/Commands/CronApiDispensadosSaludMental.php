...
class CronApiDispensadosSaludMental extends Command
{
     ...
     * @var string
     */
    protected $signature = 'cron:api_dispensadossaludmental';
     ...
     * @var string
     */
    protected $description = 'Comando para sincronizar cada 1 minuto los dispensados que se hayan generado en RFAST';
    ...
    public function handle(Request $request)
    {
        ...
        try {
            ...
            $responsefacturas = Http::withToken($token)->get($ip.$puerto."/api/dispensadoapi");
            ...
            Log::info('Cron Salud Mental '.$contador . ' Lineas dispensadas'. 'usuario: server');
            ...
            Log::info('Cron Salud Mental local'.$contador . ' Lineas dispensadas'. 'usuario: server');
