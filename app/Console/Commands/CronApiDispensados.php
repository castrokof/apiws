...
class CronApiDispensados extends Command
{
     ...
     * @var string
     */
    protected $signature = 'cron:api_dispensados';
    ...
    public function handle(Request $request)
    {
        ...
        try {
            ...
            Log::info('Cron Autopista '.$contador . ' Lineas dispensadas'. ' Usuario: server');
            ...
            Http::withToken($token)->get("http://192.168.10.27/api/closeallacceso");
               ...
               Log::info('Cron Autopista local '.$contador . ' Lineas dispensadas'. ' Usuario: server');
